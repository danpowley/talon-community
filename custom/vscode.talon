...
# bookmarks
bar bookmarks: user.vscode("bookmarksExplorer.focus")
file bookmarks: user.vscode("bookmarks.list")
jump: user.vscode("bookmarks.listFromAllFiles")
bookmark: user.vscode("bookmarks.toggle")
labelled bookmark: user.vscode("bookmarks.toggleLabeled")
next bookmark: user.vscode("bookmarks.jumpToNext")
last bookmark: user.vscode("bookmarks.jumpToPrevious")
