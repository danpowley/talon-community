...
symbols = [
    ...
    Symbol("(", ["paren", "L paren", "left paren", "curve"], None),
    Symbol(")", ["R paren", "right paren", "recurve"], None),
    Symbol("[", None,["brack", "L brack", "bracket", "L bracket", "left bracket", "square", "L square", "left square",],),
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "resquare"]),
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash"]),
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "stash"],),
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket", "restash"]),
    Symbol("<", None, ["angle", "L Angle", "left angle", "less than", "dire"]),
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than", "monde"]),
    Symbol("^", None, ["caret", "dagger"]),
    Symbol("|", None, ["pipe"]),
